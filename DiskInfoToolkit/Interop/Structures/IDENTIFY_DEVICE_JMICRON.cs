...
namespace DiskInfoToolkit.Interop.Structures
{
    ...
    internal unsafe struct IDENTIFY_DEVICE_JMICRON
    {
        ...
        public fixed ushort Obsolute6[5];                           //54-58
        ...
        public fixed ushort Reserved2[6];                           //69-74
        ...
        public fixed ushort Reserved4[4];                           //112-115
        public ushort Reserved5;                                    // 116
        public uint   WordsPerLogicalSector;                        //117-118
        public fixed ushort Reserved6[8];                           //119-126
        public ushort RemovableMediaStatus;                         // 127
        public ushort SecurityStatus;                               // 128
        public fixed ushort VendorSpecific[31];                     //129-159
        public ushort CfaPowerMode1;                                // 160
        public fixed ushort ReservedForCompactFlashAssociation[7];  //161-167
        public ushort DeviceNominalFormFactor;                      // 168
        public ushort DataSetManagement;                            // 169
        public fixed ushort AdditionalProductIdentifier[4];         //170-173
        public fixed ushort Reserved7[2];                           //174-175
        public fixed byte CurrentMediaSerialNo[60];                 //176-205
        public ushort SctCommandTransport;                          // 206
        public fixed ushort ReservedForCeAta1[2];                   //207-208
